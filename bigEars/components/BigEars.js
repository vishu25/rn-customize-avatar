...
const BigEars = (props) => {
  ...
  const [selectedState, setSelectedState] = React.useState({
    ...
    frontHair: [
      defaultAvatar?.frontHair ? [...defaultAvatar?.frontHair] : 'variant12',
    ],
    hair: [defaultAvatar?.hair ? [...defaultAvatar?.hair] : 'long20'],
    hairColor: [
      defaultAvatar?.hairColor ? [...defaultAvatar?.hairColor] : '2c1b18',
    ],
    mouth: [defaultAvatar?.mouth ? [...defaultAvatar?.mouth] : 'variant0708'],
    nose: [defaultAvatar?.nose ? [...defaultAvatar?.nose] : 'variant12'],
    sideburn: [
      defaultAvatar?.sideburn ? [...defaultAvatar?.sideburn] : 'variant07',
    ],
    skinColor: [
      defaultAvatar?.skinColor ? [...defaultAvatar?.skinColor] : 'f8b788',
    ],
    backgroundColor: [
