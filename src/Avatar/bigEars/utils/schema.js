...
export const schema = {
  ...
  properties: {
    ...
    ear: {
      ...
      items: {
        type: 'string',
        enum: ['variant08', 'variant07', 'variant06', 'variant05', 'variant04', 'variant03', 'variant02', 'variant01'],
      },
    ...
    hairColor: {
      ...
      default: ['2c1b18', 'e8e1e1', 'ecdcbf', 'd6b370', 'f59797', 'b58143', 'a55728', '724133', '4a312c', 'c93305'],
    },
    mouth: {
      type: 'array',
      items: {
